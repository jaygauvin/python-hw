...
for quote in data_list:
	if(operator == "AND"):
		...
		for t in unique_tokens:
			words = quote.lower().replace(".", "").replace(",","").lower().split(" ") #split words by space
			for w in words:
				comparisons += 1
				if w == t:
					count += 1
					break
			if(count == len(unique_tokens)):
				foundSet.add(i)
				count = 0
				break
	else:
...
foundList.sort()
print("Comparisons Made: " + str(comparisons))
print(foundList)
dt2 = datetime.now()
print("\nDumb Search Execution Time: " + str(dt2.microsecond - dt1.microsecond));
#==========================================
# THIS IS IGNORED FROM THE SECOND TIME TEST
#==========================================
print("\nPre-Processing...")
dt1 = datetime.now()
...
dt2 = datetime.now()
print("\nPreprocessing Execution Time: " + str(dt2.microsecond - dt1.microsecond))
#=======================================
print("Performing: " + operator + " search for: " + str(unique_tokens) + "\n")
...
dt2 = datetime.now()
print("\nSmart Search Execution Time: " + str(dt2.microsecond - dt1.microsecond))